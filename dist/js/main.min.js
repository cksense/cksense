...
function video_resize(){var e,t,n=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,o=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;window.outerWidth,window.outerHeight;1.77<n/o?(e=Math.round(9*n/16),t=Math.round((e-o)/2),$("#player").css({width:n+"px"}),$("#player").css({height:e+"px"}),$("#player").css({top:"-"+t+"px"}),$("#player").css({left:"0px"})):(t=Math.round(16*o/9),n=Math.round((t-n)/2),$("#player").css({width:t+"px"}),$("#player").css({height:o+"px"}),$("#player").css({top:"0"}),$("#player").css({left:"-"+n+"px"}))}$(document).ready(function(){var t=["slideInLeft","slideInRight","zoomIn","flipInX","flipInY","rotateIn","rotateInLeft","rotateInRight","rollIn","bounceIn","bounceInDown","bounceInUp","bounceInLeft","bounceInRight","flash",""];$("#work .row > div").each(function(){var e=t[Math.floor(Math.random()*t.length)];$(this).addClass("wow").addClass(e)}),$("#player").fadeIn(5e3),video_resize(),$(window).resize(function(){video_resize()}),(new WOW).init(),$(".slider").slick({dots:!0,speed:500});var e=new Date(2010,5,1),n=new Date,e=(new Date(n.getTime()-e.getTime())/31536e6).toFixed(0);document.getElementById("years-of-experience").innerHTML=e,$('[data-toggle="tooltip"]').tooltip()});